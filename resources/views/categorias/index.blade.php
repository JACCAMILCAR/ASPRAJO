    ...
    @endif
            <div class="row py-lg-2">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <a href="/categorias/create" class="btn btn-success btn-lg float-md-right" role="button" aria-pressed="true">Añadir Nueva Categoría</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr > 
                                    ...
                                    <td>
                                        ...
                                        <a href="/categorias/{{$categoria['id']}}/edit"><i class="fa fa-edit"></i></a>
